...
class Bootstrap {
	 ...
	 */
	const MINIMUM_ZOOM_VERSION = '3.6.20';
	...
	public function scripts() {
		...
		$translation_array = apply_filters( 'vczapi_registration_validation_text', array(
		...
		wp_localize_script( 'vczapi-pro', 'vczapi_pro', $translation_array );
