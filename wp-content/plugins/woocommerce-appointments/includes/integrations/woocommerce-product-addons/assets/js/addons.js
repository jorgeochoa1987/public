...
jQuery( function( $ ) {
	var wcPaoInitAddonTotals = {
		...
		init: function( cart ) {
			...
			$cart.find( '.wc-pao-addon-custom, .wc-pao-addon-custom-textarea, .wc-pao-addon input, .wc-pao-addon textarea, .wc-pao-addon select, input.qty, .variations select' ).trigger( 'change' );
