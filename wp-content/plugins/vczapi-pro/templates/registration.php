...
?>
    <div id="vczapi-pro-registration-container" class="vczapi-pro-registration-container">
		...
		if ( ! is_user_logged_in() && ! empty( $zoom['pro'] ) && empty( $zoom['pro']['registration_condition'] ) ) {
			echo '<p>' . __( 'You need to be logged in to register or join this meeting.', 'vczapi-pro' ) . '</p><a href="' . $from . '">' . __( 'Go back to event page.', 'vczapi-pro' ) . '</a>';
		...
		<?php } else { ?>
            <div class="vczapi-pro-registration-container--registration-wrap">
                ...
                <form action="" method="POST" class="vczapi-pro-registration-form" id="vczapi-pro-registration-form">
					...
					if ( ! empty( $settings['meeting_registration_fields'] ) ) {
						?>
                        <!-- Additonal Questions-->
						<?php if ( in_array( 'address', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'zip', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'state', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'phone', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'industry', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'organization', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'job', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'purchasing_time', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'role_in_purchase', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'no_of_employees', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
						...
						<?php } ?>
						<?php if ( in_array( 'comments', $settings['meeting_registration_fields'] ) ) { ?>
                            <div class="registration-form__control">
