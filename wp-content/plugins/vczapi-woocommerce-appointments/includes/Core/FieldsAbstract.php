...
use Codemanas\ZoomWooCommerceAppointments\Core\FieldsInterface;
...
abstract class FieldsAbstract implements FieldsInterface {
	...
	public function __construct() {
		...
		$this->options_page = 'edit.php?post_type=zoom-meetings&page=zoom-video-conferencing-settings&tab=woocommerce-appointments-licensing&section=licensing';
	}
