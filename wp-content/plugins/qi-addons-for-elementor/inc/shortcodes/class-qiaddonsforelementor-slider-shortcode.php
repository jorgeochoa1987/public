...
abstract class QiAddonsForElementor_Slider_Shortcode extends QiAddonsForElementor_Framework_Shortcode {
	...
	public function get_slider_classes( $atts ) {
		...
		$holder_classes[] = 'together' === $atts['slider_navigation_position'] && ! empty( $atts['slider_navigation_together_alignment'] ) ? 'qodef-navigation-alignment--' . $atts['slider_navigation_together_alignment'] : '';
