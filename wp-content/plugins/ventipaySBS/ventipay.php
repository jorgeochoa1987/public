<?php
/**
 * Plugin Name: VentiPaySBS
 * Plugin URI: https://docs.ventipay.com/
 * Description: Acepta Suscripciones a traves de ventipay.
 * Author: VentiPay-SBS
...
function ventipay_add_gateway_class($methods)
{
  ...
  $methods[] = WC_Gateway_VentiPay_SCP::class;
  return $methods;
}
...
function ventipay_init_gateway_class()
{
  ...
  require_once dirname( __FILE__ ) . '/includes/class-wc-gateway-ventipay-scp.php';
}
?>